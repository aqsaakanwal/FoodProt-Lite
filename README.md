...
🚀 **Live Demo:** [Launch FoodProt-Lite](https://foodprot-lite-yjd9qtvdaw5lryaukxkjz4.streamlit.app/)

📂 **GitHub Repository:** [View Source Code](https://github.com/aqsaakanwal/FoodProt-Lite)

> **Note:** FoodProt-Lite is an independent educational prototype using synthetic data. It is not the official FoodProt platform and is not affiliated with San Diego State University.
...
Current evaluation results from the prototype:
...
Because the dataset is synthetic, these results should **not** be interpreted as experimentally validated scientific performance.
...
Provides a summary of the dataset and the complete computational workflow.
...
```bash
git clone https://github.com/aqsaakanwal/FoodProt-Lite.git
cd FoodProt-Lite
...
🚀 **[Launch FoodProt-Lite](https://foodprot-lite-yjd9qtvdaw5lryaukxkjz4.streamlit.app/)**

## Disclaimer

FoodProt-Lite is an **independent educational prototype** created to demonstrate a possible workflow for food-protein data organization, analysis, and machine learning.

It uses synthetic data and should not be used to make experimental, clinical, food-safety, or industrial decisions.

It is **not the official FoodProt platform** and is **not affiliated with San Diego State University**.
